...
Review these files for compliance against the comprehensive rules below. Output concise but comprehensive—sacrifice grammar for brevity. High signal-to-noise.
